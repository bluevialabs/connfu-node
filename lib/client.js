        ...
        whitelist: function(phone) {
          if (!phone) {
            return {
              ...
              get: function(callback) {
                _get('/channels/voice/' + voiceName + '/whitelisted', {}, callback);
              },
              ...
              remove: function(callback) {
                _delete('/channels/voice/' + voiceName + '/whitelisted', {}, callback);
              }
            };
          }
          ...
          return {
            ...
            get: function(callback) {
              _get('/channels/voice/' + voiceName + '/whitelisted/' + querystring.escape(phone), {}, callback);
            },
            ...
            remove: function(callback) {
              _delete('/channels/voice/' + voiceName + '/whitelisted/' + querystring.escape(phone), {}, callback);
            }
          };
        },
